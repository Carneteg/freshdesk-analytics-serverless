...
function toCsv(rows: Row[]) {
  const header = ["id","subject","status","priority","age_minutes","risk","created_at","updated_at","tags","group_id","agent_id","freshdesk_ticket_url"];
                  ...
                  <tr key={r.id} className="border-t hover:bg-slate-50">
                    ...
                    <td className="p-3">
                      <span className={`inline-block h-3 w-3 rounded-full ${
                        r.risk === "red" ? "bg-red-500" :
                        r.risk === "amber" ? "bg-amber-500" :
                        "bg-green-500"
                      }`} />
                    </td>
